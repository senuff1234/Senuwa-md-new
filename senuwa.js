...
async function sessdl() {
  try {
    ...
    const base64Data = sess.SESSION_ID.split("SENUWA-MD~")[1];
    if (!base64Data) {
...
async function connectToWA() {
  ...
  //===========================
  console.log("🔥 SENUWA MD is starting...");
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      let up = `
          🚀 **𝗦𝗘𝗡𝗨𝗪𝗔-𝗠𝗗 𝗑ᴾᴿᴼ 💚 Connected Successfully!** ✅ 
          
          --- **🎉 Welcome to 𝗦𝗘𝗡𝗨𝗪𝗔-𝗠𝗗 𝗑ᴾᴿᴼ 💚!** 🎉 
          ...
          --- Thank you for using **𝗦𝗘𝗡𝗨𝗪𝗔-𝗠𝗗 𝗑ᴾᴿᴼ 💚**. 
